...
//        for (Gracz gr :
//                activePlayers) {
//            gr.setAction(new ContinueAction());
//        }
        doBettingRound();
...
//                System.out.println(actor.getName()+" "+ actor.getAction().toString());
    ...
    private void getAllowedActions(Gracz player) {
        ...
        System.out.println(player.getAction().toString());
            ...
            switch (akcja3) {
                ...
                case 2:
                    ...
                    if (wartosc1<=poprzedniaAkcja.getAmount()){
                        System.out.println("There was bet for:"+poprzedniaAkcja.getAmount()+" , raise must be higher.");
                        int wartosc2;
        ...
        }else if (poprzedniaAkcja.toString().equals("Check") || poprzedniaAkcja.toString().equals("Call")) {
    ...
    private void doShowdown() {
        ...
        List<Gracz> showingPlayers = new ArrayList<Gracz>();
        for (Pot pot : pots) {
